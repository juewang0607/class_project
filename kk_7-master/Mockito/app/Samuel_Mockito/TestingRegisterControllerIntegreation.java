...
public class TestingRegisterControllerIntegreation {
	...
	public void testRegisterPost() throws Exception {
	    ...
	    // mock the findAll method
	  	...
	  	controller.perform(post("/register").contentType(MediaType.APPLICATION_JSON).params(mm))
		.andExpect(status().is(302));
	  	...
	  	controller.perform(post("/register").contentType(MediaType.APPLICATION_JSON).params(nn))
		.andExpect(status().is(302));
