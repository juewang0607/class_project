...
public class TestingChangeApartment {
	...
	public void testChangeApartment() {
		...
		new_user.setApartment("1");
		db.save(new_user);
		ls.ChangeApartment("Test@email.com", "2");
		if (new_user.getApartment().equals("2")) {
			isRight = true;
		} else {
			isRight = false;
		}
		if (new_user.getApartment().equals("1")) {
			isWrong = true;
		} else {
			isWrong = false;
		}
