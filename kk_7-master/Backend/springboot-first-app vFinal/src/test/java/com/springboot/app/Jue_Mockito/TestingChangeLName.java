...
public class TestingChangeLName {
	...
	public void testLoginCheck()
	{
		...
		new_user.setfName("Testing_lName");
		db.save(new_user);
		ls.ChangeLName("Jue_Test@email.com", "New_Testing_lName");
		if(new_user.getlName().equals("New_Testing_lName")){
			isRight = true;
		}
		else {
			isRight = false;
		}
		if(new_user.getlName().equals("Testing_lName")){
			isWrong = true;
		}
		else {
			isWrong = false;
