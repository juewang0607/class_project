...
public class TestingChangeItemName {
	...
	public void testLoginCheck()
	{
		...
		new_item.setName("Name_Test");
		ls.changeName(new_item, "New_Name_Test");
		if(new_item.getName().equals("New_Name_Test")){
			isRight = true;
		}
		else {
			isRight = false;
		}
		if(new_item.getName().equals("Name_Test")){
			isWrong = true;
		}
		else {
			isWrong = false;
