...
public class TestingChangeEmail {
	...
	public void testLoginCheck()
	{
		...
		db.save(new_user);
		ls.changeEmail("Jue_Test@email.com", "New_Testing_Email");
		if(new_user.getEmail().equals("New_Testing_Email")){
			isRight = true;
		}
		else {
			isRight = false;
		}
		if(new_user.getEmail().equals("Jue_Test@email.com")){
			isWrong = true;
		}
		else {
			isWrong = false;
