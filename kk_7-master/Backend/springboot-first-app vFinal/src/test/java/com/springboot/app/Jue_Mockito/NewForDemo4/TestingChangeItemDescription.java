package com.springboot.app.Jue_Mockito.NewForDemo4;
...
public class TestingChangeItemDescription {
	...
	public void testLoginCheck()
	{
		...
		new_item.setName("Description_Test");
		ls.changeDescription(new_item, "New_Description_Test");
		if(new_item.getDescription().equals("New_Description_Test")){
			isRight = true;
		}
		else {
			isRight = false;
		}
		if(new_item.getDescription().equals("Description_Test")){
			isWrong = true;
		}
		else {
			isWrong = false;
